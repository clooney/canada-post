...
In order to use this API, you need to generate a Canada Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code.  use  Canada Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Canada Post Tracking API](https://www.trackingmore.com/canada-post-tracking.html)  to:

   *   Get Canada Post realtime tracking info of muti-carriers in one integration
   *   Provide Canada Post shipment tracking experience like Amazon
   *   Push Canada Post  notifications of package update with webhook
   *   Verify Canada Post delivery exception before it is too late
